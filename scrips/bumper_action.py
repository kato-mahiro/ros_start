...
import actionlib #actionlibを使うためにimportが必要
#自分で定義したAction Message をimportする
from ros_start.msg import GoUntilBumperAction #Actionを定義するクラス
from ros_start.msg import GoUntilBumperResult # Actionの実行結果を返すためのクラス
from ros_start.msg import GoUntilBumperFeedback # Actionの途中経過を返すためのクラス
